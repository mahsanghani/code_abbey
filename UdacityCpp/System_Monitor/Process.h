...
std::string Process::getUser() const { return this->user_; }

std::string Process::getCmd() const { return this->cmd_; }
...
std::string Process::getUpTime() const { return this->up_time_; }
...
std::string Process::getProcess() {
  ...
  return (this->pid_ + "   " + this->user_ + "   " + this->mem_.substr(0, 5) +
          "   " + this->cpu_.substr(0, 5) + "   " +
          this->up_time_.substr(0, 5) + "   " + this->cmd_.substr(0, 30) +
          "...");
}
#endif