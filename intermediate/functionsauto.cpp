...
int main(){
    ...
    std::cout << "sizeof(some_var) : " << sizeof(some_var3) << std::endl;
    std::cout << "sizeof(x) : " << sizeof(x) << std::endl;
    std::cout << "&some_var : " << &some_var3 << std::endl;
    ...
    double& some_var_ref2 {some_var};

    auto& z = some_var_ref; // z is deduced as a double reference
    ++z;

    std::cout << "sizeof(some_var) : " << sizeof(some_var2) << std::endl; // 8
    std::cout << "sizeof(some_var_ref) : " << sizeof(some_var_ref2) << std::endl; // 8
    std::cout << "sizeof(z) : " << sizeof(z) << std::endl; // 8
    std::cout << "&some_var : " << &some_var2 << std::endl;// 0xabc123
    std::cout << "&some_var_ref : " << &some_var_ref2 << std::endl;// 0xabc123
    std::cout << "&z : " << &z << std::endl;// 0xabc123
    std::cout << "some_var : " << some_var2 << std::endl; // 56.5
    std::cout << "some_var_ref : " << some_var_ref2 << std::endl; //56.5
